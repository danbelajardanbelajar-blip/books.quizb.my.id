    ...
    <div className="w-full bg-white p-6 md:p-10 rounded-2xl shadow-md text-slate-700 leading-relaxed my-4">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mb-4">Jika Anda memiliki pertanyaan, permintaan, atau kekhawatiran mengenai kebijakan privasi ini, silakan hubungi kami melalui email:</p>
          <a href={`mailto:${CONTACT}`} className="font-bold text-[#5d4037] hover:text-amber-700 bg-[#f4ebd0] px-4 py-2 rounded-lg inline-block">{CONTACT}</a>
        </section>
      </div>
    </div>
  );
